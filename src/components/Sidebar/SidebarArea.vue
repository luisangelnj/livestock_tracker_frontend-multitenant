...
const menuGroups = ref([
  {
    ...
    menuItems: [
      ...
      // },
      {
        icon: `<svg class="size-6 -m-[0.2rem]"
                  viewBox="3 0 18 24"
                  fill="none"
                  stroke="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
        ...
        route: '',
        children: [
          { label: 'Usuarios', route: '/forms/form-elements' },
          { label: 'Form Layout', route: '/forms/form-layout' }
        ]
      },
      {
...
<template>
  <aside
    class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-blue-950 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0"
    :class="{
