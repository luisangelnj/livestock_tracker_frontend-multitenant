...
<template>
  ...
  >
    <div class="flex flex-grow items-center justify-between lg:justify-end py-3 px-4 shadow-2 md:px-6 2xl:px-11">
      <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
        ...
        <!-- Hamburger Toggle BTN -->
        <router-link class="block flex-shrink-0 lg:hidden" :to="{name: 'dashboard'}">
